...
namespace CSharp
{
    public class PerlinNoisePattern : RTPattern
    {
        private RTPattern Pattern;
        ...
        public PerlinNoisePattern(RTPattern a) : base(Color.White, Color.Black)
        {
            Pattern = a;
        }
